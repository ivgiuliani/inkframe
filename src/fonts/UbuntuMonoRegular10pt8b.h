const uint8_t UbuntuMonoRegular10pt8bBitmaps[] PROGMEM = {
  ...
  0xA5, 0xB9, 0xA9, 0xE7, 0x42, 0x3C, 0xF8, 0x74, 0x63, 0x17, 0x00 };

const GFXglyph UbuntuMonoRegular10pt8bGlyphs[] PROGMEM = {
  {     0,   1,   1,  10,    0,    0 },   // 0x20 ' '
  {     1,   3,  12,  10,    4,  -11 },   // 0x21 '!'
  {     6,   6,   5,  10,    3,  -13 },   // 0x22 '"'
  ...
  {  1604,   8,  10,  10,    1,   -9 },   // 0xAE
  {  1614,   5,   1,  10,    2,  -11 },   // 0xAF
  {  1615,   5,   5,  10,    3,  -13 } }; // 0xB0

const GFXfont UbuntuMonoRegular10pt8b PROGMEM = {
  (uint8_t  *)UbuntuMonoRegular10pt8bBitmaps,
  (GFXglyph *)UbuntuMonoRegular10pt8bGlyphs,
  0x20, 0xB0, 20 };
